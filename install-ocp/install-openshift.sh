...
subscription-manager repos --enable "RHOCP-4.1-for-rhel-8-x86_64-debug-rpms" --enable "RHOCP-4.1-for-rhel-8-x86_64-rpms" --enable "fast-datapath-beta-for-rhel-8-x86_64-rpms" --enable "fast-datapath-beta-for-rhel-8-x86_64-source-rpms" --enable "fast-datapath-beta-for-rhel-8-x86_64-debug-rpms" --enable "RHOCP-4.1-for-rhel-8-x86_64-source-rpms"
